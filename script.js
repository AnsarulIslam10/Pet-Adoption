...
const displayDogs = async(dogs)=>{
    ...
    dogs.forEach(dog => {
        ...
        <div class="card bg-base-100 border">
                    <figure class="px-6 pt-6">
                        <img class="w-full rounded-2xl" src=${dog.image} alt="Shoes" class="rounded-xl" />
                    </figure>
                    <div class="card-body">
                        <h2 class="card-title font-bold">${dog.pet_name}</h2>
                        <div class="text-description">
                            <div class="flex items-center gap-2 text-base">
                                <img src="images/breed.png" alt="">
                                <p>Breed: ${dog.breed?dog.breed:"Not Found"}</p>
                            </div>
                            <div class="flex items-center gap-2 text-base">
                                <img src="images/calendar.png" alt="">
                                <p>Birth: ${dog.date_of_birth?dog.date_of_birth:"Not Found"}</p>
                            </div>
                            <div class="flex items-center gap-2 text-base">
                                <img src="images/gander.png" alt="">
                            ...
                            <div class="flex items-center gap-2 text-base">
                                <img src="images/dollar.png" alt="">
                                <p>Price: ${dog.price?dog.price +'$':"Not Available"}</p>
                            </div>
                        </div>
                        <div class="divider"></div>
                        <div class="card-actions items-center justify-center">
